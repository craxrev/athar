//! athar — a permanent record of developer work, reconstructed from evidence.
//!
//! The sources athar reads all destroy their own history. Claude Code deletes
...
//! file keeps only its last modified time. athar reads what they leave behind, on
...
//! work happens. Work done while athar was off is still captured, because the
